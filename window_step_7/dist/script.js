...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (calcModals);
...
const changeModalState = state => {
  ...
  //Функция по добавлению данных выбранных пользователем в объект:
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
const modals = (modalWindowSelector, triggerModalSelector, triggerCloseSelector, popupSelector, popupCalcSelector, triggerCalcSelector, triggerPhoneSelector, triggerCalcNextSelector, calcNextPopupSelector, popupCalcEndSelector, triggerCalcEndSelector) => {
...
/* harmony import */ var _modules_calcModals__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/calcModals */ "./src/js/modules/calcModals.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])('.popup_engineer', '.header_btn_wrap', '.popup_close, .popup_calc_close, .popup_calc_profile_close, .popup_calc_end_close', '.popup', '.popup_calc', '.glazing_price_btn', '.phone_link', '.popup_calc_button', '.popup_calc_profile', '.popup_calc_end', '.popup_calc_profile_button');
  ...
  (0,_modules_calcModals__WEBPACK_IMPORTED_MODULE_4__["default"])();
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('.container1', '2026-01-01');
});
})();
