...
window.addEventListener('DOMContentLoaded', () => {
  (0,_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])('.popup_engineer', '.header_btn_wrap', '.popup_close, .popup_calc_close', '.popup', '.popup_calc', '.glazing_price_btn', '.phone_link');
